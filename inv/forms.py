...
class CategoriaForm(forms.ModelForm):
    class Meta:
        ...
        labels = {'descripcion':'Descripcion de categoria', 'estado':'Estado'}
...
class MarcaForm(forms.ModelForm):
    class Meta:
        model = Marca
        fields = ['descripcion', 'estado']
        labels = {'descripcion':'Descripcion de marca', 'estado':'Estado'}
        widget = {'descripcion': forms.TextInput}
...
class UMForm(forms.ModelForm):
    class Meta:
        model = UnidadMedida
        fields = ['descripcion', 'estado']
        labels = {'descripcion':'Descripcion de unidad de medida', 'estado':'Estado'}
        widget = {'descripcion': forms.TextInput}
